...
const inputClass = 'h-[3.25rem] rounded-2xl border border-white/14 bg-white/[.06] px-4 text-base font-bold text-white outline-none transition placeholder:text-white/38 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-2xl bg-[var(--slot4-accent)] px-6 text-xs font-black uppercase tracking-[0.2em] text-[#04100f] transition hover:bg-white disabled:opacity-60'
